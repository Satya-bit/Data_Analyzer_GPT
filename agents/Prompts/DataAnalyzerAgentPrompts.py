...
3. After writing the code , wait for code executor to run it before continuing.

4. If any library is not installed in the env, please make sure to do the same by providing a bash script and use pip to install ( like pip install pandas)  
Install the required missing libraries like below
```bash
pip install pandas matplotlib
```
and after that send the code again and run again in code executor.
...
7. In the end please provide me summary with title 
**SUMMARY**
